...
<div id="main">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title">Daftar Mentor</h4>
                        </div>
                        <div>
                            <a href="/dashboard/mentors/create" class="badge bg-primary">Tambah Data</a>
                        </div>
                    </div>
    ...
    @foreach ($mentors as $mentor)
        ...
        <div class="modal fade" id="deleteMentor{{ $mentor->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>yakin menghapus data Mentor
                            <b>"{{ $mentor->nama }}"</b>
                        </p>
                    </div>
                    <div class="modal-footer">
                        <form action="/dashboard/mentors/{{ $mentor->id }}" method="POST" class="d-inline">
