                    ...
                    <div class="card-content p-4">
                        ...
                        <form action="/dashboard/events" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                is-invalid
                            @enderror"
                                    id="tentang" rows="6" name="tentang" placeholder="tentang">{{ old('tentang') }}</textarea>
                                @error('tentang')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div id="materi">
                                    <textarea id="summernote" rows="6" name="materi" placeholder="materi" input="materi">{{ old('materi') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                is-invalid
                            @enderror"
                                    id="dark" rows="6" name="sk" placeholder="syarat ketentuan">{{ old('sk') }}</textarea>
                                @error('sk')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    id="lokasi" placeholder="lokasi" name="lokasi" value="{{ old('lokasi') }}">
                                @error('lokasi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                is-invalid
                            @enderror"
                                    id="peralatan" rows="3" name="peralatan" placeholder="peralatan">{{ old('peralatan') }}</textarea>
                                @error('peralatan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                is-invalid
                            @enderror"
                                    id="pendaftaran" rows="3" name="pendaftaran" placeholder="syarat pendaftaran">{{ old('pendaftaran') }}</textarea>
                                @error('pendaftaran')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                @enderror"
                                        ...
                                        @foreach ($recomendeds as $recomended)
                                            @if (old('recomended_id') == $recomended->id)
