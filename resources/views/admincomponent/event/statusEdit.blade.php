            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title">Edit Data Status <b>"{{ $status->status }}"</b></h4>
                        </div>
                        <div>
                            <a href="/dashboard/statuses" class="btn btn-primary btn-sm"><i
                        ...
                        <form action="/dashboard/statuses/{{ $status->id }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    is-invalid
                                @enderror"
                                    id="status" placeholder="nama status" name="status"
