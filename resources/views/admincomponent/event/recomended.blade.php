...
<div id="main">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title">Daftar Menu Rekomendasi</h4>
                        </div>
                        <div>
                            <a href="/dashboard/recomendeds/create" class="badge bg-primary">Tambah Data</a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($recomendeds as $recomended)
                                        <tr>
                                            ...
                                            <td>{{ $recomended->recomended }}</td>
                                            <td>
                                                <a href="/dashboard/recomendeds/{{ $recomended->id }}/edit">
                                                    <i class="badge-circle badge-circle-light-secondary font-medium-1 text-warning"
                                                        data-feather="edit"></i>
                                                </a>

                                                <a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#deleteRecomended{{ $recomended->id }}">
    ...
    @foreach ($recomendeds as $recomended)
        ...
        <div class="modal fade" id="deleteRecomended{{ $recomended->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>yakin menghapus data Rekomendasi
                            <b>"{{ $recomended->recomended }}"</b>
                        </p>
                    </div>
                    <div class="modal-footer">
                        <form action="/dashboard/recomendeds/{{ $recomended->id }}" method="POST" class="d-inline">
