            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title">Daftar Menu Status</h4>
                        </div>
                        <div>
                            <a href="/dashboard/statuses/create" class="badge bg-primary">Tambah Data</a>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>yakin menghapus data Status
                            <b>"{{ $status->status }}"</b>
                        </p>
                    </div>
                    <div class="modal-footer">
                        <form action="/dashboard/statuses/{{ $status->id }}" method="POST" class="d-inline">
