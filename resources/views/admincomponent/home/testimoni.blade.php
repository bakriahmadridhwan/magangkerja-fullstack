...
<div id="main">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title">Konten Testimoni</h4>
                        </div>
                        <div>
                            <a href="/dashboard/testimonis/create" class="btn btn-primary btn-sm"><i
                                    data-feather="plus"></i>
                                Tambah Data</a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($testimonis as $testimoni)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/dashboard/testimonis/{{ $testimoni->id }}">
                                                    <i class="badge-circle badge-circle-light-secondary font-medium-1 text-info"
                                                        data-feather="eye"></i>
                                                </a>

                                                <a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#deleteTestimoni{{ $testimoni->id }}">
                                                ...
                                                {{-- <button type="button" class="text-danger border-0 bg-transparent"
                                                    ...
                                                    data-bs-target="#deleteModal{{ $testimoni->id }}"><i
    ...
    @foreach ($testimonis as $testimoni)
        ...
        <div class="modal fade" id="deleteTestimoni{{ $testimoni->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>yakin menghapus data testimoni berikut :
                            <br>
                            <br>
                            <b>"{{ $testimoni->testimoni }}"</b>
                            <br>
                            dengan nama <b>{{ $testimoni->nama }}</b>
                        </p>
                    </div>
                    <div class="modal-footer">
                        <form action="/dashboard/testimonis/{{ $testimoni->id }}" method="POST" class="d-inline">
