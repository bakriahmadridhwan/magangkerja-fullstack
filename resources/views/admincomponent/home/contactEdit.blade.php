            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title">Edit Data Tagline <b>"{{ $contact->tagline }}"</b></h4>
                        </div>
                        <div>
                            <a href="/dashboard/contacts" class="btn btn-primary btn-sm"><i
                        ...
                        <form action="/dashboard/contacts/{{ $contact->id }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    is-invalid
                                @enderror"
                                    id="tagline" placeholder="tag line" name="tagline"
                                    value="{{ old('tagline', $contact->tagline) }}">
                                @error('tagline')
                            ...
                            <div class="form-group mb-3">
                                ...
                                is-invalid
                            @enderror"
                                    id="deskripsi" rows="6" name="deskripsi">{{ old('deskripsi', $contact->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
