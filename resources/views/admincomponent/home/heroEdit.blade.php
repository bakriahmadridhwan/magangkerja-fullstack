            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title">Edit Data Tagline <b>"{{ $hero->tagline }}"</b></h4>
                        </div>
                        <div>
                    ...
                    <div class="card-content p-4">
                        <form action="/dashboard/heroes/{{ $hero->id }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    is-invalid
                                @enderror"
                                    id="tagline" placeholder="tag line" name="tagline" data-parsley-required="true"
                            ...
                            <div class="form-group">
                                <label for="tekswarna" class="form-label">Judul (untuk teks berwarna)</label>
                                <input type="text"
                                    class="form-control @error('tekswarna')
                                is-invalid
                            @enderror"
                                    id="tekswarna" placeholder="teks yang mau dikasih warna" name="tekswarna"
                                    value="{{ old('tekswarna', $hero->tekswarna) }}">
                                @error('tekswarna')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                is-invalid
                            @enderror"
                                    id="deskripsi" rows="6" name="deskripsi">{{ old('deskripsi', $hero->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
