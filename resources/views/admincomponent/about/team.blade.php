...
<div id="main">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title">Konten Team</h4>
                        </div>
                        {{-- <div>
                            <a href="/dashboard/team/create" class="btn btn-primary btn-sm"><i
                                    data-feather="plus"></i>
                                Tambah Data</a>
                        </div> --}}
                    </div>
                                ...
                                <tbody>
                                    @foreach ($teams as $team)
                                        <tr>
                                            ...
                                            <td>{{ $team->nama }}</td>
                                            <td class="col-2">
                                                <a href="/dashboard/teams/{{ $team->id }}">
                                                ...
                                                {{-- <a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#deleteTeam{{ $team->id }}">
    ...
    @foreach ($teams as $team)
        ...
        <div class="modal fade" id="deleteTeam{{ $team->id }}" tabindex="-1" role="dialog"
