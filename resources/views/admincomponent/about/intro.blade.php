...
<div id="main">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title">Konten Intro</h4>
                        </div>
                        {{-- <div>
    ...
    @foreach ($intros as $intro)
        ...
        <div class="modal fade" id="deleteIntro{{ $intro->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>yakin menghapus data <b>"{{ $intro->tagline }}"</b></p>
                    </div>
                    <div class="modal-footer">
                        <form action="/dashboard/intros/{{ $intro->id }}" method="POST" class="d-inline">
