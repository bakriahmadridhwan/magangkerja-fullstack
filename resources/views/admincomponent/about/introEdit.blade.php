            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title">Edit Data Tagline <b>"{{ $intro->tagline }}"</b></h4>
                        </div>
                        <div>
                    ...
                    <div class="card-content p-4">
                        <form action="/dashboard/intros/{{ $intro->id }}" method="POST"
                            ...
                            <fieldset>
                                <div class="input-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="hidden" name="oldImage" value="{{ $intro->image }}">
                                        <input type="file"
                            ...
                            <div class="form-group mb-3">
                                ...
                                is-invalid
                            @enderror"
                                    id="deskripsi" rows="6" name="deskripsi">{{ old('deskripsi', $intro->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
