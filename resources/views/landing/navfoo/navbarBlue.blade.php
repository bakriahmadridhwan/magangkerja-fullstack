    ...
    <nav>
        ...
        <div class="links">
            ...
            <a href="/events" id="event"
                class="{{ Request::is('events') || Request::is('search') || Request::is('categories') ? 'active' : '' }}">Event<span></span></a>
            ...
            <div class="dropdown">
                ...
                <div id="myDropdown" class="dropdown-content">
                    ...
                    <a href="/pesertas" class="{{ Request::is('pesertas') ? 'active' : '' }}">Karya Peserta</a>
                </div>
            </div>
