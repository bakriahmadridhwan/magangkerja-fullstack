...
<div class="main-container-category">
    ...
    <div class="searchbar-category">
        ...
        <form action="{{ url('cari') }}" method="GET">
            ...
            <div class="search-input">
                <input type="text" name="eventsearch" id="eventsearch" placeholder="cari event ..."
    ...
    <div class="container-category">
        ...
        <div class="body-category">
            ...
            <div class="row-event" id="rowevent">
                {{-- @if ($events->count()) --}}
                @if (count($eventsajax) > 0)
                    @foreach ($eventsajax as $allevent)
                        <a href="/events/{{ $allevent->id }}" id="aevent">
                            <div class="card-event">
                                <div class="header-event">

                                    @if ($allevent->mentor->image)
                                        <img src="{{ asset('storage/' . $allevent->mentor->image) }}"
                                            alt="mentor-image">
                                    @else
