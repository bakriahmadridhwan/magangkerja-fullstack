...
<div class="container-achievement">
    <div class="text-achievement">
        <h1><span class="judul1">Magang </span><span class="judul2">Kerja.ID </span>Event</h1>
        <p>Magang Kerja.ID menyediakan berbagai event menarik
            dengan berbagai materi menarik yang bisa kamu ikuti.
            Yuk ikutan, dijamin ketagihan!</p>
    </div>
    <div class="gambar-achievement">
        <img src="/img/header-event.png" alt="gambar-achievement">
    </div>
</div>
